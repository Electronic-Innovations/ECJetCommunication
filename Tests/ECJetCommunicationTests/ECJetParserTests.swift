...
final class ECJetParserTests: XCTestCase {
    ...
    func testNext() throws {
        ...
        let tokeniser = Tokenizer()
        tokeniser.append(input: data)
        let packet1 = tokeniser.next()
        let packet2 = tokeniser.next()
        ...
        XCTAssertEqual(tokeniser.buffer, [])
    }
    ...
    func testNext2() throws {
        ...
        XCTAssertEqual(packet2, nil)
        XCTAssertEqual(tokeniser.buffer, [126, 0, 15, 0, 12, 0, 0, 0, 0, 0, 0, 0, 0, 189, 60])
    }
    ...
    func testNext4() throws {
        ...
        XCTAssertEqual(packet2, nil)
        XCTAssertEqual(tokeniser.buffer, [0, 20, 0, 12])
    }
